...
with gr.Blocks(theme=gr.themes.Base(), title='EasyGUI 💻') as app:
    with gr.Tabs():
        with gr.TabItem("Inference"):
            gr.HTML("<h1> Easy GUI v2 rejekts & laynz28</h1>")
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Advanced Settings", open=False):
                        f0method0 = gr.Radio(
                            ...
                            choices=["pm", "dio",  "mangio-crepe-tiny", "crepe", "rmvpe"], # Fork Feature. Add Crepe-Tiny
                            value="rmvpe",
                            interactive=True,
                        )
